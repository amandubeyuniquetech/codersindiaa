...
const PythonMockTestL3 = ({ TestNo }) => {
  ...
  useEffect(() => {
    fetch(`/PythonQuiz/hard-${TestNo}.json`)
 ...
 const PythonL3MockTest1 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={1} />
  ...
  const PythonL3MockTest2 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={2} />
  ...
  const PythonL3MockTest3 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={3} />
  ...
  const PythonL3MockTest4 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={4} />
  ...
  const PythonL3MockTest5 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={5} />
  ...
  const PythonL3MockTest6 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={6} />
  ...
  const PythonL3MockTest7 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={7} />
  ...
  const PythonL3MockTest8 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={8} />
  ...
  const PythonL3MockTest9 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={9} />
  ...
  const PythonL3MockTest10 = ()=>{
    return (
      <>
      <PythonMockTestL3 TestNo={10} />
...
export {PythonMockTestL3, PythonL3MockTest1, PythonL3MockTest2, PythonL3MockTest3, PythonL3MockTest4,PythonL3MockTest5, PythonL3MockTest6, PythonL3MockTest7,PythonL3MockTest8, PythonL3MockTest9, PythonL3MockTest10}
