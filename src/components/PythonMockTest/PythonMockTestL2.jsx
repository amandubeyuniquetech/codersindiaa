...
const PythonMockTestL2 = ({ TestNo }) => {
  ...
  useEffect(() => {
    fetch(`/PythonQuiz/medium-${TestNo}.json`)
 ...
 const PythonL2MockTest1 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={1} />
  ...
  const PythonL2MockTest2 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={2} />
  ...
  const PythonL2MockTest3 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={3} />
  ...
  const PythonL2MockTest4 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={4} />
  ...
  const PythonL2MockTest5 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={5} />
  ...
  const PythonL2MockTest6 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={6} />
  ...
  const PythonL2MockTest7 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={7} />
  ...
  const PythonL2MockTest8 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={8} />
  ...
  const PythonL2MockTest9 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={9} />
  ...
  const PythonL2MockTest10 = ()=>{
    return (
      <>
      <PythonMockTestL2 TestNo={10} />
...
export {PythonMockTestL2, PythonL2MockTest1, PythonL2MockTest2, PythonL2MockTest3, PythonL2MockTest4,PythonL2MockTest5, PythonL2MockTest6, PythonL2MockTest7,PythonL2MockTest8, PythonL2MockTest9, PythonL2MockTest10}
